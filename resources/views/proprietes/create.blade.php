...
@section('content')
    <div class="card">
        <header class="card-header">
            <p class="card-header-title">Création d'une propriété</p>
        </header>
        <div class="card-content">
            <div class="content">
                <form action="{{ route('proprietes.store') }}" method="POST">
                    @csrf
                    <div class="field">
                    ...
                    <div class="field">
                        <label class="label">Numéro de la propriété</label>
                        <div class="control">
                          <input class="input @error('numero') is-danger @enderror" type="text" name="numero" value="{{ old('numero') }}" placeholder="Numéro de la propriété">
                        </div>
                        @error('numero')
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                          <input class="input @error('photo') is-danger @enderror" type="text" name="photo" value="{{ old('photo') }}" placeholder="Photo de la propriété">
                        </div>
                        @error('photo')
                            <p class="help is-danger">{{ $message }}</p>
                        @enderror
